        ...
        <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 xl:px-16 2xl:px-20 py-3 sm:py-4 md:py-0">
          <div className="grid grid-cols-1 md:grid-cols-[55%_45%] gap-4 sm:gap-5 md:gap-8 lg:gap-12 xl:gap-16 items-center">
            ...
            <div className="flex flex-col gap-2.5 sm:gap-3 animate-fade-in-up">
              {/* Main Image — short on mobile, taller on desktop, always viewport-aware */}
            ...
            <div className="flex flex-col gap-3 sm:gap-4 md:gap-5 lg:gap-6 animate-fade-in-up" style={{ animationDelay: '100ms' }}>
              ...
              <div className="flex flex-row gap-3 sm:gap-4 pt-1 sm:pt-2">
                ...
                <button
                  className="flex-1 px-4 sm:px-6 py-3 sm:py-3.5 md:py-4 bg-[#b8860b] text-[#0a0a0a] font-bold text-xs sm:text-sm uppercase tracking-[0.12em] sm:tracking-[0.15em] hover:bg-[#c9a84c] active:scale-[0.98] transition-all cursor-pointer shadow-[0_0_24px_rgba(184,134,11,0.15)]"
                >
                  Buy Now
                </button>
              </div>
